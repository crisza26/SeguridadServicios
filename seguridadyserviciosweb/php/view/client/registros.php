...
<html class="html" lang="es-ES">
 <head>
  ...
  <script type="text/javascript">
   if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["jquery-1.8.3.min.js", "museutils.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "registros.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/registros.css?3986379710" id="pagesheet"/>
  <!-- Other scripts -->
  <script type="text/javascript">
 ...
 <body>
  ...
  <div class="rounded-corners clearfix" id="page"><!-- column -->
   ...
   <ul class="AccordionWidget clearfix colelem" id="accordionu481"><!-- vertical box -->
    <li class="AccordionPanel clearfix colelem" id="u525"><!-- vertical box --><div class="AccordionPanelTab clearfix colelem" id="u539-4"><!-- content --><p>Eliminar usuarios</p></div><div class="AccordionPanelContent disn clearfix colelem" id="u526"><!-- column --><div class="Button rounded-corners clearfix colelem" id="buttonu527"><!-- container box --><div class="clearfix grpelem" id="u529-4"><!-- content --><p>Alejandro</p></div></div><div class="Button rounded-corners clearfix colelem" id="buttonu533"><!-- container box --><div class="clearfix grpelem" id="u534-4"><!-- content --><p>Elizabeth</p></div></div></div></li>
    <li class="AccordionPanel clearfix colelem" id="u510"><!-- vertical box --><div class="AccordionPanelTab clearfix colelem" id="u524-4"><!-- content --><p>Crear usuarios</p></div><div class="AccordionPanelContent colelem" id="u511"><!-- simple frame --></div></li>
   </ul>
...
Muse.Utils.initWidget('#accordionu481', function(elem) { return new WebPro.Widget.Accordion(elem, {canCloseAll:false,defaultIndex:1}); });/* #accordionu481 */
